...
powershell Checkpoint-Computer -Description 'MonsterFPS Restore Point' >nul
...
TITLE MonsterFPS Control Panel %version%
cls
echo.
echo.
echo.
...
if /i "%choice%"=="4" goto Debloat
if /i "%choice%"=="5" goto ServiceDisable
if /i "%choice%"=="6" goto Affinity
if /i "%choice%"=="7" goto Revert
...
cls
echo About
echo Owned by Om Thakur.
echo.
echo Opening website...
start "" "https://monsterfps.netlify.app/"
echo.
call :ColorText 8 "                                                      [ press X to go back ]"
echo.
echo.
...
:Policies
cls
echo We are not responsible for any damage caused by using this software. 
echo.
echo.
call :ColorText 8 "                                                      [ press X to go back ]"
echo.
...
:keep
powershell Invoke-WebRequest "https://monsterfps.netlify.app/api/downloads/MonsterFPS.pow" -OutFile "c:\resources\MonsterFPS.pow" >nul 
cls
powercfg /d 44444444-4444-4444-4444-444444444448 >nul 
powercfg -import "c:\resources\MonsterFPS.pow" 44444444-4444-4444-4444-444444444448 >nul
powercfg -SETACTIVE "44444444-4444-4444-4444-444444444448" >nul
powercfg /changename 44444444-4444-4444-4444-444444444448 "MonsterFPS Ultimate Power Plan" "The Ultimate Power Plan to reduce latency and boost FPS." >nul
goto tweaks
...
powershell Invoke-WebRequest "https://data-cdn.mbamupdates.com/web/mb5-setup-consumer/MBSetup.exe" -OutFile "C:\Resources\adwcleaner.exe" >nul
